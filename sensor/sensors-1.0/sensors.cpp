...
/* MTK sensor type */
...
#ifdef CUSTOM_KERNEL_FLAT_SENSOR
    {
        ...
        .handle     = ID_FLAT+ID_OFFSET,
        .type       = SENSOR_TYPE_FLAT,
        .maxRange   = FLAT_RANGE,
        .resolution = FLAT_RESOLUTION,
        .power      = FLAT_POWER,
        .minDelay   = FLAT_MINDELAY,
        .fifoReservedEventCount = FLAT_FIFO_RESERVE_COUNT,
        .fifoMaxEventCount = FLAT_FIFO_MAX_COUNT,
        .stringType = SENSOR_STRING_TYPE_FLAT,
        .maxDelay   = FLAT_MAXDELAY,
        .flags      = FLAT_FLAGS,
        .reserved   = {}
    },
#endif
...
#ifdef CUSTOM_KERNEL_UNCALI_GYRO_SENSOR
    {
        ...
        .vendor     = GYRO_TEMPERATURE_VENDER,
        .version    = GYRO_TEMPERATURE_VERSION,
        .handle     = ID_GYRO_TEMPERATURE + ID_OFFSET,
        .type       = SENSOR_TYPE_GYRO_TEMPERATURE,
        .maxRange   = GYRO_TEMPERATURE_RANGE,
        .resolution = GYRO_TEMPERATURE_RESOLUTION,
        .power      = GYRO_TEMPERATURE_POWER,
        .minDelay   = GYRO_TEMPERATURE_MINDELAY,
        .fifoReservedEventCount = GYRO_TEMPERATURE_FIFO_RESERVE_COUNT,
        .fifoMaxEventCount = GYRO_TEMPERATURE_FIFO_MAX_COUNT,
        .stringType = SENSOR_STRING_TYPE_GYRO_TEMPERATURE,
        .maxDelay   = GYRO_TEMPERATURE_MAXDELAY,
        .flags      = GYRO_TEMPERATURE_FLAGS,
        .reserved   = {}
    },
#endif
        ...
        struct sensor_t const** list)
{
    ...
    *list = sSensorList;
    count = ARRAY_SIZE(sSensorList);

    mSensorManager->addSensorsList(sSensorList, count);
    return count;
}
