...
LOCAL_SHARED_LIBRARIES := liblog libcutils libutils libstagefright_foundation libksensor
LOCAL_SRC_FILES := \
    SensorBase.cpp \
    sensors.cpp \
    SensorContext.cpp \
...
ifeq ($(VANZO_MAGNETOMETER_QMCX983), yes)
    LOCAL_CFLAGS += -DCUSTOM_KERNEL_ORIENTATION_SENSOR
    LOCAL_CFLAGS += -DMAG_CALIBRATION_FAST
endif
