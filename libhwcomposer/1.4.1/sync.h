...
public:
    ...
    unsigned int getLastMarker() { AutoMutex l(m_lock); return m_last_marker; }

    unsigned int getCurrMarker() { AutoMutex l(m_lock); return m_curr_marker; }
