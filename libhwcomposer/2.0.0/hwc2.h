...
class HWCBuffer : public android::LightRefBase<HWCBuffer>
{
    public:
        ...
        void afterPresent(const bool& is_disp_connected, const bool& is_ct = false);
...
public:
    ...
    void validate();
    void afterPresent(const bool& is_disp_connected);
...
public:
    ...
    void buildVisibleLayersSortedByZ();
    ...
    DbgLogger& editPresentValiStateLog() { return m_present_vali_state_log; }
private:
    ...
    DbgLogger m_present_vali_state_log;
};
...
/* Skip Validate */
    ...
    void buildVisibleLayerForAllDisplay();
