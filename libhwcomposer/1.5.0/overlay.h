...
struct OverlayPortParam
{
    ...
    hwc_rect_t ovl_dirty_rect[DispDevice::MAX_DIRTY_RECT_CNT];
...
public:
    ...
    void trigger(bool ovl_valid, int num_layers, int present_fence_idx, int prev_present_fence,
                 bool av_grouping, EXTD_TRIGGER_MODE trigger_mode = TRIGGER_NORMAL);
...
private:
    ...
    void packageFrameInfo(sp<FrameInfo>& info, bool ovl_valid, int num_layers,
