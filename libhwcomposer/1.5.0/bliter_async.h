...
public:
    ...
    // If the job_id is 0, it will release all fence of MDP job
    virtual void nullop(uint32_t job_id = 0);
...
private:
    ...
    void clearBackground(buffer_handle_t handle, int curr_orient, int* fence, MdpJob* job);
