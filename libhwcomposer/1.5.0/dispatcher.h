...
struct HWLayer
{
    ...
    hwc_rect_t surface_damage_rect[DispDevice::MAX_DIRTY_RECT_CNT];
...
public:
    ...
    // verifyFbtType() is used to verify if fbt layer type is changed
    int verifyFbtType(int dpy, int idx);
    ...
    // resetCurrentHwLayerState() is used to reset the state of overlay
    void resetCurrentHwLayerState(int dpy);

    // storeCurrentHwLayerState() is used to store the state of overlay
    void storeCurrentHwLayerState(int dpy);

    // setCurrentHwLayerState() is used to change the state of appointed overlay
    void setCurrentHwLayerState(int dpy, int idx, bool state);

    // clearHwLayerStateLocked() is used to clear the state of all overlay
    void clearHwLayerStateLocked(int dpy);
