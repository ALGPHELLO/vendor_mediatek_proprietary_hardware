...
ifeq ($(MTK_HWC_VERSION), 1.4.0)

LC_MTK_PLATFORM = $(shell echo $(MTK_PLATFORM) | tr A-Z a-z )

LOCAL_MODULE := hwcomposer.$(TARGET_BOARD_PLATFORM).1.4.0
...
MTK_HWC_PLATFORM_SRC := $(TOP)/$(MTK_ROOT)/hardware/libhwcomposer/$(LC_MTK_PLATFORM)/platform.cpp
