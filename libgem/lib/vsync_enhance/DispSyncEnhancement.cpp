...
bool DispSyncEnhancement::addEventListener(status_t* res, Mutex* mutex, const char* name, nsecs_t phase, const sp<DispSync::Callback>& callback) {
...
bool DispSyncEnhancement::removeEventListener(status_t* res, Mutex* mutex, const sp<DispSync::Callback>& callback) {
