...
#define SENS_TYPE_SHAKE           38
#define SENS_TYPE_SNAPSHOT        39
#define SENS_TYPE_PICK_UP         40
#define SENS_TYPE_FLIP            41
#define SENS_TYPE_ANSWER_CALL     42
#define SENS_TYPE_STATIONARY_DETECT 43
#define SENS_TYPE_MOTION_DETECT   44
#define SENS_TYPE_FREEFALL        45
#define SENS_TYPE_INPOCKET        46
#define SENS_TYPE_WAKE_UP         47
#define SENS_TYPE_GEOFENCE        48
#define SENS_TYPE_FLOOR_COUNT     49
#define SENS_TYPE_LIFT            50
#define SENS_TYPE_DEAD_RECKON     51
#define SENS_TYPE_GLANCE          52
#define SENS_TYPE_RGBW            53
/* if you want to add sensType in this file, you should add it follows
 * SENS_TYPE_WAKE_UP, SENS_TYPE_END is the last sensor type
 */
#define SENS_TYPE_END             SENS_TYPE_RGBW
