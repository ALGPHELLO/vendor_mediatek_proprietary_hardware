...
LOCAL_C_INCLUDES:= \
    ...
    $(MTK_PATH_SOURCE)/hardware/audio/common/utility/uthash \
...
LOCAL_SRC_FILES+= \
    ...
    $(LOCAL_COMMON_PATH)/utility/audio_sample_rate.c \
    ...
    $(LOCAL_COMMON_PATH)/V3/aud_drv/AudioALSACaptureHandlerTDM.cpp \
    ...
    $(LOCAL_COMMON_PATH)/V3/aud_drv/AudioALSAANCController.cpp \
    $(LOCAL_COMMON_PATH)/V3/aud_drv/AudioALSACaptureDataProviderModemDai.cpp \
    $(LOCAL_COMMON_PATH)/V3/aud_drv/AudioALSACaptureHandlerModemDai.cpp \
    $(LOCAL_COMMON_PATH)/V3/aud_drv/AudioALSANLEController.cpp \
    $(LOCAL_COMMON_PATH)/V3/aud_drv/AudioUSBPhoneCallController.cpp \
    $(LOCAL_COMMON_PATH)/V3/aud_drv/AudioSCPPhoneCallController.cpp \
    ...
    $(LOCAL_COMMON_PATH)/V3/aud_drv/AudioALSAPlaybackHandlerUsb.cpp \
    $(LOCAL_COMMON_PATH)/V3/aud_drv/AudioExternWrapper.cpp \
    $(LOCAL_COMMON_PATH)/V3/aud_drv/AudioALSACaptureDataProviderUsb.cpp \
    $(LOCAL_COMMON_PATH)/V3/aud_drv/AudioALSACaptureDataProviderEchoRefUsb.cpp \
...
#    LOCAL_CFLAGS += -DAUDIO_UTIL_PULSE_LEVEL=16000
    ...
    LOCAL_C_INCLUDES += \
        ...
        $(MTK_PATH_SOURCE)/hardware/audio/common/utility \
        $(MTK_PATH_SOURCE)/hardware/audio/common/utility/uthash \
        $(MTK_PATH_SOURCE)/hardware/audio/common/aurisys/utility \
        $(MTK_PATH_SOURCE)/hardware/audio/common/aurisys/framework

    LOCAL_SHARED_LIBRARIES += libxml2

    LOCAL_SRC_FILES += \
        $(LOCAL_COMMON_PATH)/aurisys/utility/aurisys_utility.c \
        $(LOCAL_COMMON_PATH)/aurisys/utility/aurisys_adb_command.c \
        $(LOCAL_COMMON_PATH)/aurisys/utility/audio_pool_buf_handler.c \
        $(LOCAL_COMMON_PATH)/aurisys/utility/AudioAurisysPcmDump.c \
        $(LOCAL_COMMON_PATH)/aurisys/framework/aurisys_config_parser.c \
        $(LOCAL_COMMON_PATH)/aurisys/framework/aurisys_controller.c \
        $(LOCAL_COMMON_PATH)/aurisys/framework/aurisys_lib_manager.c \
        $(LOCAL_COMMON_PATH)/aurisys/framework/aurisys_lib_handler.c \
        $(LOCAL_COMMON_PATH)/V3/aud_drv/AudioALSACaptureDataClientAurisysNormal.cpp
endif
...
LOCAL_C_INCLUDES += $(MTK_PATH_SOURCE)/external/aurisys/interface
LOCAL_SRC_FILES += $(LOCAL_COMMON_PATH)/V3/aud_drv/AudioMessengerIPI.cpp
endif

ifeq ($(MTK_AURISYS_PHONE_CALL_SUPPORT),yes)
LOCAL_CFLAGS += -DMTK_AURISYS_PHONE_CALL_SUPPORT
LOCAL_SRC_FILES += $(LOCAL_COMMON_PATH)/V3/speech_driver/SpeechDriverOpenDSP.cpp
endif
...
ifeq ($(strip $(MTK_ENABLE_MD5)),yes)
  ...
  ifeq ($(strip $(MTK_MULTI_SIM_SUPPORT)), dsda)
    ...
    LOCAL_SRC_FILES+= \
        $(LOCAL_COMMON_PATH)/V3/speech_driver/SpeechDriverDSDA.cpp \
