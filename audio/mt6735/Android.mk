...
ifeq ($(strip $(MTK_TTY_SUPPORT)),yes)
  ...
  ifeq ($(MTK_TC9_FEATURE),yes)
    ...
    LOCAL_CFLAGS += -DMTK_AUDIO_TTY_SPH_ENH_SUPPORT
  endif
endif
...
ifeq ($(MTK_SUPPORT_TC1_TUNNING),yes)
  ...
  ifneq ($(MTK_AUDIO_TUNING_TOOL_VERSION),)
    ifneq ($(strip $(MTK_AUDIO_TUNING_TOOL_VERSION)),V1)
      ...
      ifneq ($(MTK_AUDIO_TUNING_TOOL_V2_PHASE),1)
        # new gain table, bypass old ones.
...
#Set the unprocessed input source total gain with 124 to boost 6dB analog gain and pass CTS test
LOCAL_CFLAGS += -DUNPROCESSED_UL_TOTAL_GAIN=124

#Set the drop ms after besrecrd
#LOCAL_CFLAGS += -DDROP_MS_AFTER_BESRECORD_PROCESS=40

# Boost echoref
#LOCAL_CFLAGS += -DBOOST_ECHOREF
