...
******************************************************************************
*/
static const char     kPrefixOfFileName[] = "/sdcard/mtklog/audio_dump/SpeechData";
 ...
 *                     Property keys
 *============================================================================*/
const char PROPERTY_KEY_SDE_DUMP_ON[PROPERTY_KEY_MAX] = "persist.af.sph_enc_dump_on";
const char PROPERTY_KEY_SDE_DELAY[PROPERTY_KEY_MAX] = "persist.af.sph_enc_delay";
...
int SpeechDataEncrypter::Start() {
    ...
    if (mStarted) {
        ...
        if (mDumpEnabled) {
            ...
            strftime(dump_file_path_enc_pre, kMaxSizeOfFileName, "/sdcard/mtklog/audio_dump/%Y_%m_%d_%H%M%S_EncPre.dump", timeinfo);
            strftime(dump_file_path_enc_post, kMaxSizeOfFileName, "/sdcard/mtklog/audio_dump/%Y_%m_%d_%H%M%S_EncPost.dump", timeinfo);
            strftime(dump_file_path_dec_pre, kMaxSizeOfFileName, "/sdcard/mtklog/audio_dump/%Y_%m_%d_%H%M%S_DecPre.dump", timeinfo);
            strftime(dump_file_path_dec_post, kMaxSizeOfFileName, "/sdcard/mtklog/audio_dump/%Y_%m_%d_%H%M%S_DecPost.dump", timeinfo);
