...
status_t SpeechDriverDummy::RecordOn(record_type_t type_record) {
    ALOGW("%s() type_record=%d", __FUNCTION__, type_record);
...
status_t SpeechDriverDummy::RecordOff(record_type_t type_record) {
    ALOGW("%s() type_record=%d", __FUNCTION__, type_record);
    ResetApSideModemStatus(RAW_RECORD_STATUS_MASK);
    return INVALID_OPERATION;
}

status_t SpeechDriverDummy::SetPcmRecordType(record_type_t type_record) {
    ALOGW("%s() type_record=%d", __FUNCTION__, type_record);
    return INVALID_OPERATION;
}
 ...
 *                     TTY-CTM Control
 *============================================================================*/
status_t SpeechDriverDummy::TtyCtmOn(tty_mode_t ttyMode) {
    ALOGW("%s(), ttyMode = %d", __FUNCTION__, ttyMode);
...
status_t SpeechDriverDummy::TtyCtmDebugOn(bool tty_debug_flag) {
    ALOGW("%s(), tty_debug_flag = %d", __FUNCTION__, tty_debug_flag);
    return INVALID_OPERATION;
}
