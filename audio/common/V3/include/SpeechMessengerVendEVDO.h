#ifndef ANDROID_SPEECH_MESSENGER_VendEVDO_H
#define ANDROID_SPEECH_MESSENGER_VendEVDO_H
...
class SpeechMessengerVendEVDO {
public:
    SpeechMessengerVendEVDO();
    ~SpeechMessengerVendEVDO();
    status_t    Initial();
    status_t    DeInitial();
...
private:
    ...
    //open VendEVDO modem and send at command directly
...
private:
    ...
    int         atcmd_fd;//for send direct VendEVDO modem
    int         mRecordSR;
};
...
#endif //SPEECH_MESSENGER_VendEVDO_H
