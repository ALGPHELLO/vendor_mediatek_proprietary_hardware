...
public:
    ...
    status_t updateHardwareBufferInfo(size_t sourceWrittenBytes, uint32_t targetWrittenBytes);
...
protected:
    ...
    */
    ...
    void InitArsiTaskConfig(struct aurisys_lib_manager_t *manager);
    ...
    uint32_t mAurisysScenario; /* aurisys_scenario_t */
