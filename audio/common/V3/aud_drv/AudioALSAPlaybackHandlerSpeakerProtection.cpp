...
int AudioALSAPlaybackHandlerSpeakerProtection::pause() {
    return -ENODATA;
}

int AudioALSAPlaybackHandlerSpeakerProtection::resume() {
    return -ENODATA;
}

int AudioALSAPlaybackHandlerSpeakerProtection::flush() {
    return 0;
}
