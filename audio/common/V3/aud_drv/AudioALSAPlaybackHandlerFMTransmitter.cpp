...
int AudioALSAPlaybackHandlerFMTransmitter::pause() {
    return -ENODATA;
}

int AudioALSAPlaybackHandlerFMTransmitter::resume() {
    return -ENODATA;
}

int AudioALSAPlaybackHandlerFMTransmitter::flush() {
    return 0;
}

status_t AudioALSAPlaybackHandlerFMTransmitter::setVolume(uint32_t vol __unused) {
    return INVALID_OPERATION;
}

int AudioALSAPlaybackHandlerFMTransmitter::drain(audio_drain_type_t type __unused) {
    return 0;
}
