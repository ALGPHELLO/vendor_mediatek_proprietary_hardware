 ...
 *                     TTY-CTM Control
 *============================================================================*/
status_t SpeechDriverLAD::TtyCtmOn(tty_mode_t ttyMode) {
    ...
    retval = pCCCI->SendMessageInQueue(pCCCI->InitCcciMailbox(MSG_A2M_CTM_ON, ttyMode, 0));
...
status_t SpeechDriverLAD::SetAllSpeechEnhancementInfoToModem() {
    ...
    uint16_t speechEnhancementCore = 2;
#else
