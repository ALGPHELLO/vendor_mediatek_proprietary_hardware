...
int AudioFtmBase::SetSpkMonitorParam(void *pParam __unused) {
    ALOGW("%s()", __FUNCTION__);
    return 0;
}

int AudioFtmBase::GetSpkMonitorParam(void *pParam __unused) {
    ALOGW("%s()", __FUNCTION__);
    return 0;
}

void AudioFtmBase::EnableSpeakerMonitorThread(bool enable __unused) {
    ALOGW("%s()", __FUNCTION__);
    return;
}
...
bool AudioFtmBase::SpeakerCalibration() {
    ALOGW("%s()", __FUNCTION__);
    return false;
}
