...
status_t AudioMTKFilterManager::init(uint32_t flags) {
    ...
    do {
        ...
        if (AudioCustParamClient::GetInstance()->GetAudEnhControlOptionParamFromNV(&audioParam)) {
...
void AudioMTKFilterManager::setParamFixed(bool flag) {
    ...
    AudioCustParamClient::GetInstance()->SetAudEnhControlOptionParamToNV(&audioParam);
#endif
#else
