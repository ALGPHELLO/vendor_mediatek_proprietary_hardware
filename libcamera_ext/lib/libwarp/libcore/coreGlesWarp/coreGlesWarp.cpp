...
void CoreGlesWarp::InitEGLImage(void)
{
...
void CoreGlesWarp::GlesWarpingInit(void)
{
    bool OK ;
...
void CoreGlesWarp::GlesWarpingMain(void)
{
    bool OK;
    printf("CoreGlesWarp::GlesWarpingMain \n");
    OK = GlesWarping();
    if(!OK)
    {
...
void CoreGlesWarp::GlesWarpingReset(void)
{
    bool OK;
...
bool CoreGlesWarp::CreateShderProgram(const char*vs, const char*fs)
{
    bool OK = true;
    bool NoOK = false;
    /*
...
bool CoreGlesWarp::DestroyShaderProgram()
{
    bool OK = true;
    bool NoOK = false;
...
bool CoreGlesWarp::GlesWarping()
{
    ...
    for(int i=0; i<core_info.InputBufferHead; i++)
    ...
    for(int i=0; i<core_info.OutputBufferHead; i++)
    ...
    */
    ...
    sprintf(dft, "%d", 0);
    property_get("debug.eis.demo", value, dft);
