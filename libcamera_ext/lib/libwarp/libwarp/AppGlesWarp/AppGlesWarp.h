...
#ifndef _APP_GLES_WARP_H
#define _APP_GLES_WARP_H
...
/*****************************************************************************
    Class Define
******************************************************************************/
class AppGlesWarp : public MTKWarp {
public:
...
private:
    WARP_STATE_ENUM      WarpState;
    //static WarpImageExtInfo     WarpInput;
    WarpResultInfo       WarpResult;
    MUINT32              WarpSetBufferSize; //= WARP_BUFFER_UNSET;
    MUINT32              WarpReqBufferSize;

    CoreGlesWarp                warp_obj;
    CreateGLESContext            context_obj;
