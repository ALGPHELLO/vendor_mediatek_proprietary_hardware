...
MFLOAT utilLevmarL2nrmxmy(MFLOAT *e, MFLOAT *x, MFLOAT *y, MINT32 n)
{
    register MINT32 i;
    MINT32 blockn;
    register MFLOAT sum0=0.0;

    register size_t addr_e, addr_x, addr_y;
    addr_e = (size_t)e;
    addr_x = (size_t)x;
    addr_y = (size_t)y;
...
void utilLevmarTransMatMatMult(MFLOAT *a, MFLOAT *b, MINT32 n, MINT32 m)
{
    ...
    register MINT32 i, j, k, jj, kk;
    register MFLOAT sum, *bim, *akm;
...
MINT32 utilLevmarBcDer(LEVMAR_CAL_STRUCT *pLevmarInfo, MINT32 para_max_iter)
{
    ...
    *pDp;
    ...
    for(k=0; k<para_max_iter && !stop; ++k)
    {
        ...
        {
            register MINT32 l, im;
            register MFLOAT alpha, *jaclm;
...
void utilforElim_int(const MINT32 *L, MINT32 *y, const MUINT32 n, const MUINT32 _FRAC_BITS)
{
    ...
    register MINT32 v;
    register MINT32 *y_ptr0 = NULL, *y_ptr1 = NULL;
    register const MINT32 *row_start = NULL, *row = NULL;
...
void utiltranspose_int(MINT32 *M, const MUINT32 n)
{
    ...
    register MINT32 t;
    register MINT32 *M_ptr = NULL, *row_ptr = NULL, *col_ptr = NULL;                   // M_ptr: point to each diagonal element, row_ptr: pointer to a row, col_ptr: pointer to a column
