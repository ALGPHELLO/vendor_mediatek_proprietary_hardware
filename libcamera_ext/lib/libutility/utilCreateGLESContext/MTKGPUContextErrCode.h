...
#ifndef _MTK_GPU_CONTEXT_ERRCODE_H
#define _MTK_GPU_CONTEXT_ERRCODE_H
...
#define MODULE_MTK_GPU_CONTEXT (0) // Temp value

#define MTK_GPU_CONTEXT_OKCODE(errid)         OKCODE(MODULE_MTK_GPU_CONTEXT, errid)
#define MTK_GPU_CONTEXT_ERRCODE(errid)        ERRCODE(MODULE_MTK_GPU_CONTEXT, errid)


// Detection error code
#define S_GPU_CONTEXT_OK                  MTK_GPU_CONTEXT_OKCODE(0x0000)

#define E_GPU_CONTEXT_OVER_WRITE           MTK_GPU_CONTEXT_ERRCODE(0x0001)
#define E_GPU_CONTEXT_WRONG_VERSION       MTK_GPU_CONTEXT_ERRCODE(0x0002)
#define E_GPU_CONTEXT_EGL_DISPLAY_FAIL    MTK_GPU_CONTEXT_ERRCODE(0x0003)
#define E_GPU_CONTEXT_CHOOSE_CONFIG_FAIL  MTK_GPU_CONTEXT_ERRCODE(0x0004)
#define E_GPU_CONTEXT_PBUFFER_SURFACE_FAIL  MTK_GPU_CONTEXT_ERRCODE(0x0005)
#define E_GPU_CONTEXT_CREATE_CONTEXT_FAIL  MTK_GPU_CONTEXT_ERRCODE(0x0006)

#define E_GPU_CONTEXT_ERR                 MTK_GPU_CONTEXT_ERRCODE(0x0100)
