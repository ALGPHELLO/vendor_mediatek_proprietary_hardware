...
class CcuDrv
{
    ...
    public:
        ...
        virtual MBOOL   init(const char* userName="", 
            ...
            MINT8 *log_buf_va_0=0, MINT8 *log_buf_va_1=0) = 0;
...
class CcuDrvImp : public CcuDrv
{
    ...
    public:
        ...
        virtual MBOOL   loadSensorBin(WHICH_SENSOR_T sensorDev, uint8_t sensor_slot);
        virtual MBOOL   initI2cController(enum CCU_I2C_CHANNEL i2c_controller_id);
    ...
    private:
        virtual MBOOL   allocateDdrBuffer();
