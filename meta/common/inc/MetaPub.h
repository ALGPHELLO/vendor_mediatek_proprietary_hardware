...
#define  MDLOG_PULL_STATUS      "debug.pullmdlog"
#define  MDLOG_EE_PULL_STATUS   "debug.mdl.EE.done"


#define  MBLOG_SOCKET_NAME      "mobilelogd"
#define  MBLOG_PULL_START       "ext_autopull"
#define  MBLOG_PULL_STOP        "ext_autostop"
