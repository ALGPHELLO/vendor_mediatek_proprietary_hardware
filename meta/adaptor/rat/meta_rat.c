...
#define PROPERTY_BUILD_RAT_CONFIG           "ro.mtk_protocol1_rat_config"
#define PROPERTY_RAT_CONFIG                 "ro.boot.opt_ps1_rat"
#define PROPERTY_IS_USING_DEFAULT_CONFIG    "ro.boot.opt_using_default"
#define PROPERTY_OPT_C2K_SUPPORT            "ro.boot.opt_c2k_support"
#define PROPERTY_OPT_LTE_SUPPORT            "ro.boot.opt_lte_support"
...
bool META_RAT_init() {
    ...
    char temp[128]={ 0 };
    property_get("ro.mtk_protocol1_rat_config", temp, "");
    DBG("ro.mtk_protocol1_rat_config:%s\n", temp);
...
void META_RAT_OP(RAT_REQ *req, char *peer_buff, unsigned short peer_len) {
    ...
    switch(req->op) {
        case RAT_OP_READ_OPTR:
            property_get("persist.operator.optr", temp, "");
        ...
        case RAT_OP_READ_OPTRSEG:
            property_get("persist.operator.seg", temp, "");
