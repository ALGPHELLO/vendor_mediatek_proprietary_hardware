#ifndef VENDOR_MEDIATEK_HARDWARE_PQ_V2_0_PICTUREQUALITY_H
#define VENDOR_MEDIATEK_HARDWARE_PQ_V2_0_PICTUREQUALITY_H
...
private:
    ...
    void configGamma(int picMode, gamma_entry_t *entry);
    ...
    void initColorShift();
    void configCcorrUnitGain(uint32_t ccorrCoef[3][3]);
    void initBasicGamma(void);
...
#endif  // VENDOR_MEDIATEK_HARDWARE_PQ_V2_0_PICTUREQUALITY_H
