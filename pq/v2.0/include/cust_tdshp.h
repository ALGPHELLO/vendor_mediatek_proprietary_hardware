...
#define PQ_DBG_MDP_CZ_ISP_TUNING_STR        "debug.pq.cz.isp.tuning"

#define GLOBAL_PQ_SUPPORT_STR "ro.globalpq.support"
#define GLOBAL_PQ_SUPPORT_DEFAULT "0"
#define GLOBAL_PQ_ENABLE_STR "persist.sys.globalpq.enable"
#define GLOBAL_PQ_ENABLE_DEFAULT "0"

#define GLOBAL_PQ_STRENGTH_STR "persist.sys.globalpq.strength"
