...
bool imgIon_sync(JINT32 ionFD, JINT32 bufHandle, JUINT32 isWrite = 0);
#ifdef ION_M4U_USE_MAP_API
bool imgIon_syncDone(JINT32 ionFD, JINT32 bufHandle, JUINT32 isWrite = 0);
#endif
