...
/////////////////////////////////////////////////////////////////////
static void sw_init_source(j_decompress_ptr_MTK cinfo) {
...
static boolean_MTK sw_seek_input_data(j_decompress_ptr_MTK cinfo, long byte_offset) {
    swjpeg_source_mgr* src = (swjpeg_source_mgr*)cinfo->src;
...
static boolean_MTK sw_fill_input_buffer(j_decompress_ptr_MTK cinfo) {
    swjpeg_source_mgr* src = (swjpeg_source_mgr*)cinfo->src;
...
static void sw_skip_input_data(j_decompress_ptr_MTK cinfo, long num_bytes) {
    swjpeg_source_mgr*  src = (swjpeg_source_mgr*)cinfo->src;
...
static boolean_MTK sw_resync_to_restart(j_decompress_ptr_MTK cinfo, int desired) {
    // unused params
	(void)desired;
...
static void sw_term_source(j_decompress_ptr_MTK /*cinfo*/) {}
...
static void sw_init_destination(j_compress_ptr_MTK cinfo) {
...
static boolean_MTK sw_empty_output_buffer(j_compress_ptr_MTK cinfo) {
    swjpeg_destination_mgr* dest = (swjpeg_destination_mgr*)cinfo->dest;
...
static void sw_term_destination (j_compress_ptr_MTK cinfo) {
    swjpeg_destination_mgr* dest = (swjpeg_destination_mgr*)cinfo->dest;
...
void swjpeg_error_exit(j_common_ptr_MTK cinfo) {
