...
ifneq (,$(filter $(strip $(TARGET_BOARD_PLATFORM)), mt2601 mt6572 mt8127 mt8163 mt8167 mt7623))
...
ifneq (,$(filter $(strip $(TARGET_BOARD_PLATFORM)), mt6735 mt6737t mt6735m mt6737m mt6753 mt6752 mt6755 mt6750 mt6757 mt6595 mt6795 mt6797 mt6799 mt8173 elbrus kiboplus))
...
ifneq (,$(filter $(strip $(TARGET_BOARD_PLATFORM)), mt6759 mt6763 mt6758 mt6739 mt3886 mt6771 mt6775))
...
ifneq (,$(filter $(strip $(TARGET_BOARD_PLATFORM)), mt6763 mt6739))
LOCAL_SHARED_LIBRARIES += \
  libvcodec_utility
