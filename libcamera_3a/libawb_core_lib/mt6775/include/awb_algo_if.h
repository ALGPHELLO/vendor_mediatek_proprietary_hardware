...
#define AWB_ALGO_IF_REVISION    7521001
namespace NS3A
{
...
public:
    ...
    virtual MRESULT initAWB(AWB_INIT_INPUT_T &a_rAWBInitInput,
                            ...
                            AWB_GAIN_T &a_rAWBRAWPreGain1, AWB_GAIN_T &a_rAWBRAWPreGain1M, AWB_GAIN_T &a_rAWBRAWPreGain1L) = 0;
    ...
    /**
     * @brief set AWB HDR mode
     * @param [in] a_eAWBMode AWB mode; please refer to awb_feature.h
     */
    virtual MRESULT setAWBHdrMode(AWB_HDR_MODE_T a_eAWBHdrMode) = 0;
     ...
     */
    virtual MRESULT setAWBFDArea(AWB_FD_INFO_T* sNewAWBFDArea) = 0;
   ...
   /**
     ...
     * @param [in] a_rAWBInput AWB frame-based input parameters; please refer to awb_param.h
     * @param [out] pAWBStatBufOut AWB statistic data
     */
    virtual MVOID getAWBStat(AWB_INPUT_T &a_rAWBInput, MINT32 i4IsLinearMode, MINT32 i4IsMultiLit, MVOID *pAWBStatBufOut) = 0;

    /**
     * @inverse multi light source calibration
     * @param [in] i4LitIdx for 7 light sources index, and Input RGB
     * @param [out] Output RGB which are inverse to high pregain1
     */
     virtual MVOID InvCompensatedGainRGB(MINT32 i4LitIdx, MINT32 i4In_R, MINT32 i4In_G, MINT32 i4In_B,
     												  MINT32 i4Out_R, MINT32 i4Out_G, MINT32 i4Out_B) = 0;
	...
	* @return awb state
	*/
	virtual MTKAWB_STATE_ENUM getAwbState() = 0;
