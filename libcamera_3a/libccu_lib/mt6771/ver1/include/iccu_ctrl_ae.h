...
typedef struct 
{
	CCU_AE_INITI_PARAM_T ccuAeInitParam;
	AE_PARAM_T *aeParam;
	AE_NVRAM_T *nvramData;
} CcuCtrlAeInitParam;
...
{
public:
    static ICcuCtrlAe *createInstance();

    virtual void destroyInstance(void) = 0;

    virtual void getDebugInfo(AE_DEBUG_INFO_T *a_rAEDebugInfo) = 0;

    virtual void getAeInfoForIsp(AE_INFO_T *a_rAEInfo) = 0;
};
