...
typedef struct
{
    CCU_SYNC_AE_MODE_SELECTION eSyncAEMode; //Everest 2A sync //assign in syncAEMain@Sync3A.cpp
    CCU_SYNC_AE_LOCATION_TRANS_STRUCT syncTransInfo;  //Everest 2A sync //need to check
