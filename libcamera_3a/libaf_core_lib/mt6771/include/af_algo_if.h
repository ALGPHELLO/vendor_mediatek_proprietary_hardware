...
#define AF_ALGO_IF_REVISION 6503001
...
public:
     ...
     */
    virtual MRESULT trigger() = 0;
    virtual MRESULT cancel() = 0;
    virtual MRESULT lock() = 0;
    virtual MRESULT unlock() = 0;
     ...
     * @param [in] a_sAFOutput Onput AF algorithm settings to af manager; Please refer AF_OUTPUT_T in af_param.h
     */
    virtual MRESULT handleAF(const AF_INPUT_T &a_sAFInput, AF_OUTPUT_T &a_sAFOutput) = 0;
     ...
     */
    virtual MRESULT setAFParam(AF_PARAM_T a_sAFParam, AF_CONFIG_T a_sAFConfig, AF_NVRAM_T a_sAFNvram, DUALCAM_NVRAM_T a_sDUALCAMNvram) = 0;
    /**
    ...
    /**
     * @brief This function is used for AF factory calibration. It is called by ReadOTP in AF manager. It calculates and applies the factory data to AF table.
     * @param [in] a_i4MidPos Factory calibrated middle lens position.
     */
    virtual void    updateMiddleAFPos(MINT32 a_i4MidPos) = 0;
     ...
     */
    virtual MRESULT setFDWin(AF_AREA_T a_sFDInfo) = 0;         //remove at 5.0
    virtual MRESULT extendFDWin(AF_AREA_T &a_sFDInfo) = 0;
    // AF v1.2
    ...
    virtual MVOID SaveAfCoreInfo(const char *) {};
    ...
    */
    virtual MRESULT getFocusWindows(AFPD_BLOCK_ROI_T* inAfRoi, MINT32 inAfRoiNum, MINT32 inWinBufSz, AFPD_BLOCK_ROI_T* outWins, MINT32* outWinNum) = 0;
    virtual MRESULT targetAssistMove() = 0;

//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
//    AF sync API
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    virtual void   MotorRange(AF_SyncInfo_T& sCamInfo) = 0;
    virtual MINT32 GetSyncInfo(AF_SyncInfo_T& sCamInfo) = 0;
    virtual void   GetMain2CalibPos(AF_SyncInfo_T& sCamInfo) = 0;
    virtual void   CalibAFPos(AF_SyncInfo_T& sCamInfo) = 0;
    virtual DUALCAM_NVRAM_T getPosRecBuf()= 0;
    virtual void   SetSyncInfo(MINT32 a_i4Pos, AF_SyncInfo_T& sSlaveHisCamInfo)= 0;
    virtual void   SetSyncMode(MINT32 const a_i4SyncMode)= 0;
