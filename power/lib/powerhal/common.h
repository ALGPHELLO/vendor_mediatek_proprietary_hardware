...
#define PATH_WIPHY_CAM "/proc/net/wlan/setCAM"
...
#define PATH_PERFMGR_CPUSET_PID   "/proc/perfmgr/boost/cpuset_pid"
//#define PATH_PERFMGR_FORCE_SP     "/proc/perfmgr/boost/force_sp"
//#define PATH_PERFMGR_FORCE_VR     "/proc/perfmgr/boost/force_vr"
//#define PATH_PERFMGR_FORCE_CPUSET "/proc/perfmgr/boost/force_cpuset"

#define PATH_GLOBAL_CPUSET_EN     "/dev/cpuset/user_space_global_cpuset"
#define PATH_GLOBAL_CPUSET        "/dev/cpuset/cpus"
...
extern void set_value(const char * path, const int value_1, const int value_2);
extern void set_value(const char * path, const int value);
extern void set_value(const char * path, const char *str);
extern void set_value(const char * path, const string *str);
...
extern void set_wiphy_cam_level(int level);
