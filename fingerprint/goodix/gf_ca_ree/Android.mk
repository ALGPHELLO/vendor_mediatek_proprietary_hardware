...
ifeq ($(FACTORY_TEST), ree)
    ...
    LOCAL_SRC_FILES_32 := debug/armeabi-v7a/libgf_ca_ree.so
    else ifeq ($(TARGET_BUILD_VARIANT),userdebug)
    LOCAL_SRC_FILES_64 := userdebug/arm64-v8a/libgf_ca_ree.so
    LOCAL_SRC_FILES_32 := userdebug/armeabi-v7a/libgf_ca_ree.so
    else
    LOCAL_SRC_FILES_64 := release/arm64-v8a/libgf_ca_ree.so
    LOCAL_SRC_FILES_32 := release/armeabi-v7a/libgf_ca_ree.so
    endif
