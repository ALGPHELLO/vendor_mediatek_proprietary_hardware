 ...
 * All Rights Reserved.
 */
#ifndef __GF_FINGERPRINT_H__
#define __GF_FINGERPRINT_H__
...
typedef enum gf_fingerprint_acquired_info {
    ...
    GF_FINGERPRINT_ACQUIRED_TOUCH_BY_MISTAKE = 1008,
...
typedef struct gf_fingerprint_device {
    ...
    void (*factory_test_notify)(uint32_t cmd_id, gf_error_t test_result, void *test_cmd);
    void (*dump_notify)(const gf_fingerprint_dump_msg_t *msg);
} gf_fingerprint_device_t;

#endif  // __GF_FINGERPRINT_H__
