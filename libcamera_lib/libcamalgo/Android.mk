...
ifeq ($(PLATFORM), $(filter $(PLATFORM), mt6755 mt6570 mt6572 mt6580 mt6582 mt6735 mt6752 mt8163 mt8167 mt6739 mt8173))
...
LOCAL_SHARED_LIBRARIES += liblog libcutils libmtk_drvb libEGL libGLESv2 libgui libutils libbinder libui libgralloc_extra
LOCAL_MULTILIB := 64
