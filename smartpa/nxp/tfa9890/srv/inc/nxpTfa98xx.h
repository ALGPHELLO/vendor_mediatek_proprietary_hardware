...
int    tfa98xx_DspWrite( unsigned int address, int value,Tfa98xx_handle_t *handlesIn);
void tfaRun_ShowParameters( nxpTfa98xxParameters_t *parms);
unsigned int tfa98xx_DspRead( unsigned int offset, Tfa98xx_handle_t *handlesIn);
