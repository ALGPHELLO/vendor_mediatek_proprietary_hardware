...
#ifndef _MTK_FOV_ERRCODE_H
#define _MTK_FOV_ERRCODE_H
...
#define MODULE_MTK_FOV (0) // Temp value

#define MTK_FOV_OKCODE(errid)         OKCODE(MODULE_MTK_FOV, errid)
#define MTK_FOV_ERRCODE(errid)        ERRCODE(MODULE_MTK_FOV, errid)


// Detection error code
#define S_FOV_OK                  MTK_FOV_OKCODE(0x0000)

#define E_FOV_NEED_OVER_WRITE     MTK_FOV_ERRCODE(0x0001)
#define E_FOV_NULL_OBJECT         MTK_FOV_ERRCODE(0x0002)
#define E_FOV_WRONG_STATE         MTK_FOV_ERRCODE(0x0003)
#define E_FOV_WRONG_CMD_ID        MTK_FOV_ERRCODE(0x0004)
#define E_FOV_WRONG_CMD_PARAM     MTK_FOV_ERRCODE(0x0005)
#define E_FOV_INSUFF_WORK_BUF     MTK_FOV_ERRCODE(0x0006)
#define E_FOV_EGL_CONFIG          MTK_FOV_ERRCODE(0x0006)

#define E_FOV_ERR                 MTK_FOV_ERRCODE(0x0100)
