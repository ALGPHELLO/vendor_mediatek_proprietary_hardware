...
///////////////////////////////////////////////////////////////
    ...
    kal_int32 fld_leye_x0[FD_MAX_FACE_NUM];
    kal_int32 fld_leye_y0[FD_MAX_FACE_NUM];
    kal_int32 fld_leye_x1[FD_MAX_FACE_NUM];
    kal_int32 fld_leye_y1[FD_MAX_FACE_NUM];
    kal_int32 fld_reye_x0[FD_MAX_FACE_NUM];
    kal_int32 fld_reye_y0[FD_MAX_FACE_NUM];
    kal_int32 fld_reye_x1[FD_MAX_FACE_NUM];
    kal_int32 fld_reye_y1[FD_MAX_FACE_NUM];
    kal_int32 fld_nose_x[FD_MAX_FACE_NUM];
    kal_int32 fld_nose_y[FD_MAX_FACE_NUM];
    kal_int32 fld_mouth_x0[FD_MAX_FACE_NUM];
    kal_int32 fld_mouth_y0[FD_MAX_FACE_NUM];
    kal_int32 fld_mouth_x1[FD_MAX_FACE_NUM];
    kal_int32 fld_mouth_y1[FD_MAX_FACE_NUM];
