...
#ifndef _MTK_3D_VERIFY_ERRCODE_H
#define _MTK_3D_VERIFY_ERRCODE_H
...
#define MODULE_MTK_3D_VERIFY (0) // Temp value

#define MTK_3D_VERIFY_OKCODE(errid)         OKCODE(MODULE_MTK_3D_VERIFY, errid)
#define MTK_3D_VERIFY_ERRCODE(errid)        ERRCODE(MODULE_MTK_3D_VERIFY, errid)


// Detection error code
#define S_3D_VERIFY_OK                  MTK_3D_VERIFY_OKCODE(0x0000)

#define E_3D_VERIFY_NEED_OVER_WRITE     MTK_3D_VERIFY_ERRCODE(0x0001)
#define E_3D_VERIFY_NULL_OBJECT         MTK_3D_VERIFY_ERRCODE(0x0002)
#define E_3D_VERIFY_WRONG_STATE         MTK_3D_VERIFY_ERRCODE(0x0003)
#define E_3D_VERIFY_WRONG_CMD_ID        MTK_3D_VERIFY_ERRCODE(0x0004)
#define E_3D_VERIFY_WRONG_CMD_PARAM     MTK_3D_VERIFY_ERRCODE(0x0005)
#define E_3D_VERIFY_INSUFF_WORK_BUF     MTK_3D_VERIFY_ERRCODE(0x0006)
#define E_3D_VERIFY_EGL_CONFIG          MTK_3D_VERIFY_ERRCODE(0x0006)

#define E_3D_VERIFY_ERR                 MTK_3D_VERIFY_ERRCODE(0x0100)
