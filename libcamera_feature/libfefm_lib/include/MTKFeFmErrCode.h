...
#ifndef __MTK_FEFM_ERRCODE_H__
#define __MTK_FEFM_ERRCODE_H__
...
#define MODULE_MTK_FEFM             (0) // Temp value

#define MTK_FEFM_OKCODE(errid)      OKCODE(MODULE_MTK_FEFM, errid)
#define MTK_FEFM_ERRCODE(errid)     ERRCODE(MODULE_MTK_FEFM, errid)


// Detection error code
#define S_FEFM_OK                   MTK_FEFM_OKCODE(0x0000)

#define E_FEFM_NEED_OVER_WRITE      MTK_FEFM_ERRCODE(0x0001)
#define E_FEFM_NULL_OBJECT          MTK_FEFM_ERRCODE(0x0002)
#define E_FEFM_WRONG_STATE          MTK_FEFM_ERRCODE(0x0003)
#define E_FEFM_WRONG_CMD_ID         MTK_FEFM_ERRCODE(0x0004)
#define E_FEFM_WRONG_CMD_PARAM      MTK_FEFM_ERRCODE(0x0005)
#define E_FEFM_INSUFF_WORK_BUF      MTK_FEFM_ERRCODE(0x0006)
#define E_FEFM_EGL_CONFIG           MTK_FEFM_ERRCODE(0x0006)

#define E_FEFM_ERR                  MTK_FEFM_ERRCODE(0x0100)
