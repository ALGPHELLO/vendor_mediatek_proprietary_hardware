...
static UINT32 coreA_VcoreOpp=0xFF, coreB_VcoreOpp=0xFF;
static UINT32 coreA_FreqOpp=0xFF, coreB_FreqOpp=0xFF;
...
int main(int argc, char** argv)
{
    ...
    property_get("vpu.special_test_en.case_num", special_case_value, "0");
