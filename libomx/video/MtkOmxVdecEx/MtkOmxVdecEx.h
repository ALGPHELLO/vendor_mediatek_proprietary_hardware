...
typedef unsigned long MtkVideoAllocateSecureFrameBuffer_Ptr(int , int, const char*);
typedef MTK_SECURE_AL_RESULT MtkVideoFreeSecureFrameBuffer_Ptr(unsigned long);
typedef unsigned long MtkVideoRegisterSharedMemory_Ptr(void *, int, const char*);
typedef unsigned long MtkVideoAllocateSecureBuffer_Ptr(int , int, const char*);
