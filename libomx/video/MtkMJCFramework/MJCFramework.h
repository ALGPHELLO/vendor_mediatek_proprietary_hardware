...
public:
    ...
    bool SetAndCheckProp(const char *szPropName, const char *szValue);
    ...
    void EnablePerfService();
    void DisablePerfService();
    ...
    void CheckPowerSavingSettings(unsigned int u4ToBeCheckedChip);
    void RestorePowerSavingSettings(unsigned int u4ToBeCheckedChip);
