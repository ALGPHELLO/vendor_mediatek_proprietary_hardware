...
/*
 * Remove zero for user data when needed
 *
 * bytePdu [IN/OUT] the bearer data pointer
 * len     [IN] the bearer data input length
 *
 *  ret: the output length of bearer data
 */
extern int removeZero(unsigned char* bytePdu, unsigned short len);