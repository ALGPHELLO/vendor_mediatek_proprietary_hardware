...
void RilSapSocket::initSapSocket(const char *socketName,
    ...
    if (strcmp(socketName, "msap_c2k_socket1") == 0) {
...
#if (SIM_COUNT >= 2)
    if (strcmp(socketName, "msap_c2k_socket2") == 0) {
        if(!SocketExists(socketName)) {
...
#if (SIM_COUNT >= 3)
    if (strcmp(socketName, "msap_c2k_socket3") == 0) {
        if(!SocketExists(socketName)) {
...
#if (SIM_COUNT >= 4)
    if (strcmp(socketName, "msap_c2k_socket4") == 0) {
        if(!SocketExists(socketName)) {
