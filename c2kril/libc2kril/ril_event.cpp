...
static void findPidByName( char* pidName, pid_t *number)
{
    DIR *dir;
    struct dirent *next;
    ...
    LOGD("findPidByName: finding rild pid ");
    ...
    while ((next = readdir(dir)) != NULL) {
        ...
        if (strStartsWith(buffer, "Name:") && strstr(buffer, pidName)) {
