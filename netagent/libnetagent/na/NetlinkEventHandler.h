...
class NetlinkEventHandler : public NetlinkListener {
    public:
        ...
        int getFlag(void *obj, NA_RA *flag);
        int getValid(void *obj, int *valid);
    ...
    protected:
        ...
        void enqueueReqInfo(NA_CMD cmd, char *address, int ipv6PrefixLength, int interfaceId, int flag, int valid, ACTION action);
