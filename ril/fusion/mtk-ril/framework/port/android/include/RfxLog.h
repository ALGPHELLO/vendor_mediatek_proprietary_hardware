...
#define __RFX_LOG_V(_rfx_tag, ...)\
    do {\
        if (__rfx_is_gt_mode()) {\
            __rfx_android_buffer_print_V(_rfx_tag, __VA_ARGS__);\
        } else {\
...
#define RFX_LOG_D(_rfx_tag, ...) \
    do {\
        if (__rfx_is_gt_mode()) {\
            __rfx_android_buffer_print_D(_rfx_tag, __VA_ARGS__);\
        } else {\
...
#define RFX_LOG_I(_rfx_tag, ...) \
    do {\
        if (__rfx_is_gt_mode()) {\
            __rfx_android_buffer_print_I(_rfx_tag, __VA_ARGS__);\
        } else {\
...
#define RFX_LOG_W(_rfx_tag, ...) \
    do {\
        if (__rfx_is_gt_mode()) {\
            __rfx_android_buffer_print_W(_rfx_tag, __VA_ARGS__);\
        } else {\
...
#define RFX_LOG_E(_rfx_tag, ...) \
    do {\
        if (__rfx_is_gt_mode()) {\
            __rfx_android_buffer_print_E(_rfx_tag, __VA_ARGS__);\
        } else {\
