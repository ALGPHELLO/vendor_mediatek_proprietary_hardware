...
CallStatus RfxPreciseCallState::RILStateToCallStatus(RIL_CallState state) {
    switch (state) {
        case RIL_CALL_ACTIVE: return CALL_STATUS_ACTIVE;
        case RIL_CALL_HOLDING: return CALL_STATUS_HOLD;
        case RIL_CALL_DIALING:
        case RIL_CALL_ALERTING:
        case RIL_CALL_INCOMING:
        case RIL_CALL_WAITING:
            return CALL_STATUS_ATTEMPTING;
        default: return CALL_STATUS_INACTIVE;
    }
}
...
void RfxPreciseCallState::dump() {
    RFX_LOG_D("PreciseCallState",
            "slot:%d, id:%d, status:%d, type:%d, rat:%d, dir:%d, num:%s, orig:%d",
            mSlot, mCallId, mCallStatus, mCallType, mCallRat, mCallDir,
