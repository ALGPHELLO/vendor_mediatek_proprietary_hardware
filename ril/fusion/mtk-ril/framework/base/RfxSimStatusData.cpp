...
RfxSimStatusData::RfxSimStatusData(void *_data, int _length) : RfxBaseData(_data, _length) {
    if (_data != NULL) {
        RIL_CardStatus_v6 *pCard = (RIL_CardStatus_v6*)_data;
        RIL_CardStatus_v6 *pData = (RIL_CardStatus_v6*)calloc(1, sizeof(RIL_CardStatus_v6));
...
RfxSimStatusData::~RfxSimStatusData() {
    if (m_data != NULL) {
        RIL_CardStatus_v6 *pData = (RIL_CardStatus_v6*)m_data;
