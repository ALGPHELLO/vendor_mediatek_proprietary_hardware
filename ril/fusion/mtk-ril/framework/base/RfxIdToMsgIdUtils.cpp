...
int RfxIdToMsgIdUtils::idToMsgId(int id) {
    switch(id) {
        ...
        case RIL_REQUEST_SET_SIM_POWER:
            return RFX_MSG_REQUEST_SIM_SET_SIM_POWER;
        ...
        case RIL_REQUEST_RELOAD_MODEM_TYPE:
            return RFX_MSG_REQUEST_WORLD_MODE_RELOAD_MODEM_TYPE;
        case RIL_REQUEST_STORE_MODEM_TYPE:
            return RFX_MSG_REQUEST_WORLD_MODE_STORE_MODEM_TYPE;
        // world mode end
        // PHB Part -- Start
        ...
        case RIL_REQUEST_IMS_BEARER_ACTIVATION_DONE:
            return RFX_MSG_REQUEST_IMS_BEARER_ACTIVATION_DONE;
        case RIL_REQUEST_IMS_BEARER_DEACTIVATION_DONE:
            return RFX_MSG_REQUEST_IMS_BEARER_DEACTIVATION_DONE;
        /// @}
        // STK Part -- Start
...
int RfxIdToMsgIdUtils::msgIdToId(int msgId) {
    switch(msgId) {
        ...
        case RFX_MSG_REQUEST_SIM_SET_SIM_POWER:
        ...
        case RFX_MSG_REQUEST_IMS_BEARER_ACTIVATION_DONE:
            return RIL_REQUEST_IMS_BEARER_ACTIVATION_DONE;
        case RFX_MSG_REQUEST_IMS_BEARER_DEACTIVATION_DONE:
            return RIL_REQUEST_IMS_BEARER_DEACTIVATION_DONE;
        case RFX_MSG_URC_IMS_BEARER_ACTIVATION:
            return RIL_UNSOL_IMS_BEARER_ACTIVATION;
        case RFX_MSG_URC_IMS_BEARER_DEACTIVATION:
            return RIL_UNSOL_IMS_BEARER_DEACTIVATION;
