...
RFX_REGISTER_DATA_TO_EVENT_ID(RfxStringsData, RFX_MSG_EVENT_REQUEST_QUERY_CALL_BARRING);
RFX_REGISTER_DATA_TO_EVENT_ID(RfxStringsData, RFX_MSG_EVENT_REQUEST_SET_CALL_BARRING);
...
static const int event[] = {
    RFX_MSG_EVENT_REQUEST_QUERY_CALL_BARRING,
    RFX_MSG_EVENT_REQUEST_SET_CALL_BARRING
};
...
void RmcSuppServRequestSpecialHandler::onHandleEvent(const sp<RfxMclMessage>& msg) {
    int id = msg->getId();
    switch(id) {
        case RFX_MSG_EVENT_REQUEST_QUERY_CALL_BARRING:
            requestQueryCallBarring(msg);
            break;
        case RFX_MSG_EVENT_REQUEST_SET_CALL_BARRING:
