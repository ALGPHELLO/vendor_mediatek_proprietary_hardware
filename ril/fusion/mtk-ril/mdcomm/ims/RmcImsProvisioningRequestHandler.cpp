...
static const int requests[] = {
    RFX_MSG_REQUEST_GET_PROVISION_VALUE, //AT+EPVSGET
    RFX_MSG_REQUEST_SET_PROVISION_VALUE, //AT+EPVSSET
};

// register data
RFX_REGISTER_DATA_TO_REQUEST_ID(RfxStringData, RfxVoidData, RFX_MSG_REQUEST_GET_PROVISION_VALUE);
RFX_REGISTER_DATA_TO_REQUEST_ID(RfxStringsData, RfxVoidData, RFX_MSG_REQUEST_SET_PROVISION_VALUE);
