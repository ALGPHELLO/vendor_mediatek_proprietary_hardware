...
class RmcCallControlCommonRequestHandler : public RmcCallControlBaseHandler {
    ...
    protected:
        ...
        void requestDial(const sp<RfxMclMessage>& msg, bool isEcc, bool isVt);
    ...
    private:
        ...
        void requestSetEccServiceCategory(const sp<RfxMclMessage>& msg);
        void requestVoiceAccept(const sp<RfxMclMessage>& msg);
        void requestReplaceVtCall(const sp<RfxMclMessage>& msg);
        ...
        int bUseLocalCallFailCause;
        int dialLastError;
        RmcCallControlImsRequestHandler* mImsCCReqHdlr;
};
