...
public:
    ...
    static int mVsimPlugInOut[MAX_SIM_COUNT];
    // VSIM modem waiting response value: -1: N/A, 0: APDU, 1: ATR
    static int mVsimMdWaiting[MAX_SIM_COUNT];

    static void setVsimPlugInOutEvent(int slotId, int flag);
    static int getVsimPlugInOutEvent(int slotId);
    static void setMdWaitingResponse(int slotId, int waiting);
