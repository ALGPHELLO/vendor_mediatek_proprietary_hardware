...
#ifndef __RMC_CDMA_SIM_URC_HANDLER_H__
#define __RMC_CDMA_SIM_URC_HANDLER_H__
...
private:
    ...
    void handleOmhValue(const sp<RfxMclMessage>& msg, RfxAtLine *urc);
...
#endif /* __RMC_CDMA_SIM_URC_HANDLER_H__ */
