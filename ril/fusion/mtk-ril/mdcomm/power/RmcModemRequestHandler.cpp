...
void RmcModemRequestHandler::requestModemPowerOn(const sp<RfxMclMessage> &msg) {
    ...
    logD(RFX_LOG_TAG, "SET ril.ipo.radiooff to 0");
    rfx_property_set("ril.ipo.radiooff","0");
...
void RmcModemRequestHandler::requestModemPowerOff(const sp<RfxMclMessage> &msg) {
        ...
        logD(RFX_LOG_TAG, "ENTER requestRadio PowerOff, set ril.ipo.radiooff to -1");
        rfx_property_set("ril.ipo.radiooff","-1");
        ...
        logD(RFX_LOG_TAG, "requestRadioPowerOff SET ril.ipo.radiooff to 1");
        rfx_property_set("ril.ipo.radiooff","1");
