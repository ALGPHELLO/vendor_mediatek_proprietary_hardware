...
class RmcDcReqHandler : public RfxBaseHandler {
    ...
    protected:
        ...
        virtual void createDcImsHandler();
    ...
    private:
        ...
        void handleImsBearerNotify(const sp<RfxMclMessage>& msg);
        void handleImsBearerActivationDone(const sp<RfxMclMessage>& msg);
        void handleImsBearerDeactivationDone(const sp<RfxMclMessage>& msg);
        void handlePcscfAddressDiscovery(const sp<RfxMclMessage>& msg);
        /// @}
