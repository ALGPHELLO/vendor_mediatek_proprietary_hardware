...
class RmcDcUtility {
    public:
        static int isCC33Support();
        static int isCdmaSupport();
        static int isCdmaLteDcSupport();
        static int isOp07Support();
        static int isOp12Support();
        static int isOp16Support();
        static int isOp09ASupport();
        static int getAddressType(char* addr);
        static const char* getProfileType(const char* profileTypePtr);
        static const char* getMtkProfileType(const char* profileTypePtr);
        static int getApnTypeId(const char* profileTypePtr);
        static int getMtkApnTypeId(const char* profileTypePtr);
        ...
        static bool isPreferDnsV6First(int slotId);
        ...
        static const char* JIONET_MCC_MNC[];
