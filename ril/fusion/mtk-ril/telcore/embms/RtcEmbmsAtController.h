...
private:
    ...
    void responseToSocket(const sp<RfxMessage>& msg, const char *responseStr, int strLen);
    void urcToSocket(const sp<RfxMessage>& msg, const char *responseStr, int strLen);
