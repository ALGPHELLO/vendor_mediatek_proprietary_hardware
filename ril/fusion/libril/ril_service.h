...
int queryNetworkLockResponse(int slotId,
        int responseType, int serial, RIL_Errno e,
        void *response, size_t responseLen);

int setNetworkLockResponse(int slotId,
        int responseType, int serial, RIL_Errno e,
        void *response, size_t responseLen);
// MTK-END
...
int smsReadyInd(int slotId, int indicationType, int token, RIL_Errno e, void *response,
        size_t responseLen);
int setGsmBroadcastLangsResponse(int slotId,
        int responseType, int serial, RIL_Errno e, void *response, size_t responseLen);
int getGsmBroadcastLangsResponse(int slotId,
        int responseType, int serial, RIL_Errno e, void *response, size_t responseLen);
