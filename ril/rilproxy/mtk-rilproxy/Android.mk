...
LOCAL_SHARED_LIBRARIES := \
    liblog libbinder libcutils libutils librilproxy librilproxyutils libratconfig

LOCAL_HEADER_LIBRARIES := libaudioclient_headers libaudio_system_headers

LOCAL_SHARED_LIBRARIES += libcrypto libhidlbase vendor.mediatek.hardware.netdagent@1.0_vendor
...
ifeq (foo,foo)
  ...
  LOCAL_SHARED_LIBRARIES += \
      libcutils libutils librilutilsmtk
