...
static void *noopRemoveStkWarning( void *a ) { return a; }
#define RIL_STK_UNUSED_PARM(a) noopRemoveStkWarning((void *)&(a));
...
#define MTK_RIL_REQUEST_SET_STK_UTK_MODE(data,datalen,token) \
    requestSetStkUtkMode(data, datalen, token);
