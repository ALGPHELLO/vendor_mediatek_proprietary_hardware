...
#define PROP_DATA_ALLOW_STATUS "ril.data.allow.status"
...
#define PROPERTY_NEED_FOLLOW_ON "persist.ril.data.need.follow.on"
#define PROPERTY_NEED_COMBINED_ATTACH "persist.ril.data.need.combined.attach"
...
static const char RP_DATA_PROPERTY_IA[MAX_SIM_COUNT][25] = {
    "ril.c2kirat.ia.sim1",
    "ril.c2kirat.ia.sim2",
    "ril.c2kirat.ia.sim3",
    "ril.c2kirat.ia.sim4",
