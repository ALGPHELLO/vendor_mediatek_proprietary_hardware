...
extern void requestGetPacketSwitchBearer(RILSubSystemId subsystem, RIL_SOCKET_ID rid);
...
#define PROPERTY_VOLTE_ATTACHED_CS    "persist.radio.volte_attached_cs"
...
#define PROPERTY_SET_AUTO_MODE_ONLY "ril.nw.auto_selection.mode"
