...
#define RIL_NWS_UNUSED_PARM(a) ((void)(a))

extern int isCtDualModeCardInGsmOnlyMode(RIL_SOCKET_ID rid);
extern int needModeSwitchForCtDualModeCard(RIL_SOCKET_ID rid, int roamingMode);
