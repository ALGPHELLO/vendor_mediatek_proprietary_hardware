...
extern void requestSN(RILSubSystemId subsystem, RIL_SOCKET_ID rid);
...
#define PROPERTY_SIM_SWITCH_CONTROL_MAL "ril.mal"
#define PROPERTY_SIM_SWITCH_MAL_STOPPING_FLAG "ril.mal.flag"
#define PROPERTY_SIM_SWITCH_DONGLE_MODE "persist.chiptest.enable"

#define SIM_SWITCH_MAL_PHONE_MODE  (0)
